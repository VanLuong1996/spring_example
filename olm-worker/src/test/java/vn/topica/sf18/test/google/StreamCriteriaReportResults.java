...
package vn.topica.sf18.test.google;
...
/**
 * This example streams the results of an ad hoc report, collecting total impressions by campaign
 * from each line. This demonstrates how you can extract data from a large report without holding
 * the entire result set in memory or using files.
 *
